...
//   print_r($current_user); die();
  ...
  register_activation_hook(__FILE__, 'my_activation_AJCRON');

function my_activation_AJCRON() {
...
function do_this_hourly() {
  ...
  $ngo_headers3 = 'From: Indiadonates <no-reply@indiadonates.com>' . "\r\n";
  $ngo_message3="Please Resubmit information";
  $user_ngo_email_id3='ngo1@yopmail.com';
  wp_mail( $user_ngo_email_id3, "Welcome to AJAY IndiaDonates.in", $ngo_message3 , $ngo_headers3);
...
function every_three_minutes_event_func() {
    ...
    //check resbumit is expire if yes then send notification mail
    global $wpdb;
    $table_name = "wp_ngo_profile";
    $result_arr_data = $wpdb->get_results( "SELECT * FROM $table_name ORDER BY id DESC" );
    foreach ($result_arr_data as $key => $rowData) {
      if($rowData->ngo_done==0){
          if(isset($rowData->ngo_resubmit_at)){
            //  echo $rowData->ngo_resubmit_at;
              $startdate =$rowData->ngo_resubmit_at;
              ...
              if($today >= $expire){
                  ...
                  $ngo_headers3 = 'From: Indiadonates <no-reply@indiadonates.com>' . "\r\n";
                  $ngo_message3=$rowData->re_submit_info;
                  $user_ngo_email_id3=$rowData->email_id;
                  wp_mail( $user_ngo_email_id3, "Please Re submit your information also required document", $ngo_message3 , $ngo_headers3);
...
//ajcode to save add board member details
   ...
   if( $success ){
	...
	<br>
	<center>
	   <h5>Thanks for submission form </h5>
	</center>
...
<div class="container">
  ...
  <fieldset>
    ...
    <h2 class="frm-two-head">Non FCRA Account:</h2>
       ...
       <div >
          ...
          <input id="" name="nfcra_name" type="text" value="" required placeholder="Enter Bank Name"  >
          <span class="error1" style="display: none;">
              <i class="error-log fa fa-exclamation-triangle"></i>
          </span>
        </div>
    ...
    <!-- ---------------- Bank Branch Address ------------------- -->
      <div >
          ...
          <input id="" name="nfcra_branch" type="text" value=""required  placeholder="Branch Name">
          <span class="error1" style="display: none;">
              <i class="error-log fa fa-exclamation-triangle"></i>
          </span>
      </div>
    ...
    <!-- -------------------Account Number---------------------- -->
        <div >
          ...
          <input id="" name="nfcra_numb" type="text" value="" required placeholder="Account Number">
          <span class="error1" style="display: none;">
              <i class="error-log fa fa-exclamation-triangle"></i>
          </span>
        </div>
    ...
    <!-- ----------------- Name of Account---------------- -->
        <div >
          ...
          <input id="" name="nfcra_acct" type="text" value="" required placeholder="Name of Account">
          <span class="error1" style="display: none;">
              <i class="error-log fa fa-exclamation-triangle"></i>
          </span>
        </div>
    ...
    <!-- ------------------MICR number--------------------- -->
        <div >
          ...
          <input id="" name="nfcra_nmb" type="text" value="" placeholder="MICR" required>
          <span class="error1" style="display: none;">
              <i class="error-log fa fa-exclamation-triangle"></i>
          </span>
        </div>
    ...
    <!-- ---------------------------Current/Savings account----------------------- -->
      <div style="display: inline-block; width: 100%">
        ...
        <select type="select" class="crt_sav" name="nfcra_type" style="width: 100%; height: 40px;" required>
    ...
    <!-- ------------------SWIFT Code----------------------- -->
        <div >
          ...
          <input id="" name="nfcra_swift" type="text" value="" placeholder="SWIFT Code" required >
          <span class="error1" style="display: none;">
              <i class="error-log fa fa-exclamation-triangle"></i>
          </span>
        </div>
    ...
    <!-- -----------------IFSC CODE-------------------- -->
        <div >
          ...
          <input id="" name="ifsc_nfcra" type="text" value="" placeholder="IFSC Code" required>
          <span class="error1" style="display: none;">
              <i class="error-log fa fa-exclamation-triangle"></i>
          </span>
        </div>
    ...
    <h2 class="frm-two-head">FCRA Account:</h2>
       ...
       <div >
          <label for=" "><strong>Bank Name</strong></label>
          <input id="" name="fcra_name" type="text" value="" placeholder="Bank Name" required>
          <span class="error1" style="display: none;">
              <i class="error-log fa fa-exclamation-triangle"></i>
          </span>
        </div>
    ...
    <!-- ---------------- Bank Branch Address ------------------- -->
      <div >
          <label for=" "><strong>Branch Name</strong></label>
          <input id="" name="fcra_branch" type="text" value="" placeholder="Branch Name" required>
          <span class="error1" style="display: none;">
              <i class="error-log fa fa-exclamation-triangle"></i>
          </span>
      </div>
     ...
     <!-- -------------------Account Number---------------------- -->
        <div >
          <label for=" "><strong>Account Number</strong></label>
          <input id="" name="fcra_numb" type="text" value="" placeholder="Account  Number" required >
          <span class="error1" style="display: none;">
              <i class="error-log fa fa-exclamation-triangle"></i>
          </span>
        </div>
    ...
    <!-- -----------------Name of Account---------------- -->
        <div >
          <label for=" "><strong>Name of Account</strong></label>
          <input id="" name="fcra_acct" type="text" value="" placeholder="Name of Account" required>
          <span class="error1" style="display: none;">
              <i class="error-log fa fa-exclamation-triangle"></i>
          </span>
        </div>
  ...
  <fieldset>
      <div >
          ...
          <textarea id="form2-text" name="abut_org" required="required" type="textarea" value="" required placeholder="" data-rule-required="true" data-msg-required="Required" ></textarea>
          <span class="error1" style="display: none;">
              <i class="error-log fa fa-exclamation-triangle"></i>
          </span>
        </div>
                    ...
                    <table cellspacing='0' cellpadding='0' width='800' class='w320'>
                      <tr>
                        <td class='free-text pull-left'>
                         ...
                         &#39;A movement to change live’-Indiadonates.
                ...
                <?php
                  ...
                  <form method="post">
                    ...
                    <input class="btn_ngo_approve" type='button' id='btn' value='Print' onclick='printDiv();' style="width: 15%;height: 45px;">
                     ...
                     <button type="button" class="btn_ngo_approve" style="background:#16426B" data-toggle="modal" data-target="#myDueModal">Due- Diligence</button>
