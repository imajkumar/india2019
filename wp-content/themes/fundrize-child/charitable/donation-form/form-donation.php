...
<form method="post" id="<?php echo esc_attr( $form_id ); ?>" class="charitable-donation-form charitable-form" data-use-ajax="<?php echo esc_attr( $use_ajax ); ?>">
    ...
    <?php
    	//}else{
     ?>
  <!-- <a class="dnt-button button open-popup new-btn" style="padding:15px !important;" data-id="popup_11" href="#popup_11"><span><?php // echo esc_html( 'DONATE NOW', 'fundrize' ) ?></span></a> -->
    <?php
