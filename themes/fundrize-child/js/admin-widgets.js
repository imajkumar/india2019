jQuery(document).ready(function($){
    ...
    $( '.widgets-holder-wrap' ).on( 'click', '.widget-control-remove, .widget-control-close, .widget-control-save', function() {
        ...
        if ( widget_parent_div == 'sidebar-footer-1' || widget_parent_div == 'sidebar-footer-2' || widget_parent_div == 'sidebar-footer-3' || widget_parent_div == 'sidebar-footer-4' || widget_parent_div == 'sidebar-footer-5' || widget_parent_div == 'sidebar-footer-6' ) {
