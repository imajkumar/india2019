				...
				<tr>
					...
					<center>
						...
						<tr>
							...
							<p>Thank you for your donation, we are grateful for your support in bringing change in people’s lives.

							Enclosed is the receipt of your donation.
							
							Don’t hesitate to get in touch with us, in case of any questions at our email ID - <b>coordinator@indiadonates.in</b></p>
				
							<p>Please find your donation receipt below:</p>
								
							<div class='don_reciept' style='border: 1px solid #212127; padding-top: 30px; padding-left: 26px; padding-bottom: 15px; background-color: #fff;'>
							<div class='rec_inner'>
								<div class='header_rec'>
									<div class='rec_logo'>
										<img class='dev_pro_log' src='http://indiadonates.in/indiadonates/wp-content/uploads/2019/01/DevPro-final-logo.jpg'>
									</div>
									<div class='rec_head'>
										<h3 class='dev_head'>Dev Pro</h3>
									<div class='add_rec'>
								...
								<div class='RNo'>
									<span class='rno'>R.No. <b>$rn_no</b></span>
									<span class='rec_date' style='padding-right: 50px'>Date:- <b>$donation_date</b></span>
								</div>
								<div class='naming_content'>
									<p class='name_span' style='padding-left: 0px !important;'>Received with thanks from <b>$user_prefix_name  $donor_name_for</b> <label for='check01'><strong>
										 </strong>
										</label> the Sum of Rupees ( $donation_inwords   )<strong>$mail_amount </strong>
												 by  $donation_mode Date: $date_of_donation Being the donation.
								</p></div>
								<div class='content_middle_rec'>
									...
									<div class='rec_signature'>
										<span class='rec_rupees'>Rs. <strong>$mail_amount</strong></span>
...
<div class="don_reciept" style="border: 1px solid #212127; padding-top: 30px; padding-left: 26px; padding-bottom: 15px;">
	<div class="rec_inner">
		<!--<div class="logo_rec">
			<img src="http://indiadonates.in/indiadonates/wp-content/uploads/2019/01/fmst-25-yr-logo-final.jpg" width="200px" />
		</div> -->
		<div class="header_rec">
			<div class="rec_logo">
				<img class="dev_pro_log" src="http://indiadonates.in/indiadonates/wp-content/uploads/2019/01/DevPro-final-logo.jpg" />
